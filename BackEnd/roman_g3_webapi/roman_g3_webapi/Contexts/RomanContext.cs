...
namespace roman_g3_webapi.Contexts
{
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Projeto>(entity =>
            {
                entity.HasKey(e => e.IdProjeto)
                    .HasName("PK__projeto__8FCCED76C5377A5B");
                ...
                entity.HasOne(d => d.IdProfessorNavigation)
                    ...
                    .HasConstraintName("FK__projeto__idProfe__01142BA1");

                entity.HasOne(d => d.IdTemaNavigation)
                    .WithMany(p => p.Projetos)
                    .HasForeignKey(d => d.IdTema)
                    .HasConstraintName("FK__projeto__idTema__00200768");
            });
